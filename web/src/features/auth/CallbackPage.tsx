  ...
  if (error) {
    return (
      <div className="text-left">
        ...
        <a
          href="/login"
          className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-[#EC6019] hover:bg-[#d85516] text-white font-semibold text-[15px] rounded-xl transition-all duration-200"
        >
          Back to Login
        </a>
      </div>
