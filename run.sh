...
python -c "import numpy; print('✅ NumPy installed (CRITICAL)')" 2>/dev/null || echo "❌ NumPy failed - AUDIT ENGINE WILL NOT WORK"
python -c "from app.core.seo_scoring import SEOScoringEngine; print('✅ SEO Scoring Engine available')" 2>/dev/null || echo "❌ SEO Scoring Engine failed"
